	...
	public static function add_scripts() {
		...
		if ( function_exists( "is_woocommerce" ) ) {
			if ( is_woocommerce() && is_product() ) {
				...
				wp_enqueue_script( "woocommerce-variations-with-radio-buttons-frontend", plugins_url( "/assets/js/main" . $suffix . ".js", plugin_basename( __FILE__ ) ), array( "jquery", "woocommerce" ), "1.1.2", true );
			}
		}
	}
